...
clear, clc
dMax = 1.0; % maximum distance from contracted to relaxed, in pixels
f1 = 1; % contraction time factor
f2 = 1; % relaxation time factor (f2 = 2 and f1 = 1 means relaxation takes twice as long as contraction)
...
for i = 10:length(dsts)-10 % frame
    ...
    mr = imrotate(mr,45,'bicubic','crop');
